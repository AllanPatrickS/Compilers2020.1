...
class ArrSize(Exp):
    def __init(self, e):
        if isinstance(e, ArrInt) or isinstance(e, Id):
            Exp.__init__(self, e)
        else:
...
class ArrAppend(Exp):
    def __init__(self, l1, l2):
        if isinstance(l1, Exp) or isinstance(l1, ArrInt):
            if isinstance(l2, Exp) or isinstance(l2, ArrInt):
                Exp.__init__(self, l1, l2)
            else:
